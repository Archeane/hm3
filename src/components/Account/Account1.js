...
class Account1 extends React.Component {
    constructor(props) {
        ...
        this.state = {
          page: true,
          username: localStorage.firstname, //"Dummy User",
          educationLvl: "Undergraduate",
          year: "2019",
          major: "Computer Science",
          propic: localStorage.propic, //"https://storage.cloud.google.com/hackersmatcher/default.jpg",
          ...
          intList: ['Artificial Intelligence', 'Computer Vision', 'Machine Learning', 'Computational Theory', 'Bioinformatics','Cloud Computing','Data science', 'Big Data', 'Data Visualization', 'Block Chain', 'AR/VR', 'Robotics', 'Hardware','Mechanical Design', 'Electrical Engineering', 'UI/UX Design', 'Web Dev', 'iOS Dev', 'Android Dev', 'HCI', 'Graphics', 'Gaming', 'Networks', 'Database management', 'NoSQL', 'Game Development', 'Android Development'],
          langList: ['Javascript','Java', 'C#', 'PHP', 'Android', 'Python', 'HTML', 'CS', 'Swift', 'Ruby On Rails', 'SQL', 'C', 'C++', 'Go', 'Objective-C'],
          techList : ['AWS', 'Watson', 'Oculus', 'Apache', 'React Native', 'D3', 'React', 'Spark', 'Flask', 'Django', 'Node.js', 'MongoDB', 'ASP.net', 'Ruby', 'Twilio', 'Objective-C', 'Angular', 'Vue.js', 'Laravel', 'Pandas', 'Oracle', 'Bootstrap', 'OpenCV', 'Azure', 'Tensorflow', 'Google-Cloud', 'Firebase', 'Google-Maps', 'Oracle', 'Xamarin', 'Ionic', 'Heroku'],
          fieldList : ['Finance', 'Health', 'Mental Health', 'Education', 'Environmental', 'Science', 'Social Good', 'Urban Innovation', 'Medical', 'Social Networking', 'Astronomy', 'Human Assistance', 'Music', 'Art', 'Helping Developing Countries', 'Cars', 'Sports', 'Social conflicts', 'Disaster Relief']
