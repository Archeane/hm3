  ...
  constructor(props) {
    ...
    this.state = {
      ...
      hackathons : [{
                    ...
                    {propic: "https://i.imgur.com/fQENxfu.png?1",
                    hackName: "TechTogetherNYC",
  ...
  render(){
      ...
      if (true) {
          ...
          <Container>
              ...
              <Row>
                <Col>
                    <HackathonCard hackInfo={this.state.hackathons[0]}/>
                </Col>
               
                <Col>
                    <HackathonCard hackInfo={this.state.hackathons[1]}/>
                </Col>
              </Row>
          {/* <Row>
            <Col>
