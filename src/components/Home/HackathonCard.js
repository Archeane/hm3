        ...
        return (
            ...
            <div className="hackcard col-md-5 offset-md-1">
                <div className="firstinfo">
                  ...
                  <a href={`/hackathon/${this.state.hackInfo.hackName}`}><img className="hackImg d-block mx-auto rounded-circle img-fluid" src={this.state.hackInfo.propic}></img></a>
                  <div className="profileinfo">
                      <a href={`/hackathon/${this.state.hackInfo.hackName}`}><h1>{this.state.hackInfo.hackName}</h1></a>
                      <i>{this.state.hackInfo.school}</i>
                      <p className="bio">{this.state.hackInfo.startDate} - {this.state.hackInfo.endDate}</p>
